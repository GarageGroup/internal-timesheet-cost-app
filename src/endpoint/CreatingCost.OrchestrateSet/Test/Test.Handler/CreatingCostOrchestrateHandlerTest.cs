...
{
    private static readonly OrchestrationActivityCallOut<ProjectCostSetDeleteOut> SomeDeleteFalseOut
        =
        new(
            value: new()
            {
    ...
    private static readonly OrchestrationActivityCallOut<ProjectCostSetDeleteOut> SomeDeleteTrueOut
        =
        new(
            value: new()
            {
    ...
    private static Mock<IOrchestrationActivityApi> BuildMockOrchestration(
        in Result<OrchestrationActivityCallOut<ProjectCostSetDeleteOut>, Failure<HandlerFailureCode>> firstDeleteResult,
        in Result<OrchestrationActivityCallOut<ProjectCostSetDeleteOut>, Failure<HandlerFailureCode>> secondDeleteResult,
    ...
    {
        var queue = new Queue<Result<OrchestrationActivityCallOut<ProjectCostSetDeleteOut>, Failure<HandlerFailureCode>>>([firstDeleteResult, secondDeleteResult]);
