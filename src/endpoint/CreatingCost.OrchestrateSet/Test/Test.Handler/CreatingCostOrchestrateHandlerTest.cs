...
public static partial class CreatingCostOrchestrateHandlerTest
{
    ...
    private static readonly CreatingCostSetOrchestrateIn SomeInput
        =
        new(
            systemUserId: new("d7ac9d0a-6c0f-463e-a9e4-68ab5b465dc7"),
        ...
        in Result<Unit, Failure<HandlerFailureCode>> createResult)
    {
        ...
        _ = mock
            .Setup(
                static a => a.CallActivityAsync<ProjectCostSetDeleteIn, ProjectCostSetDeleteOut>(
                    It.IsAny<OrchestrationActivityCallIn<ProjectCostSetDeleteIn>>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(deleteResult);

        _ = mock
            .Setup(
                static a => a.CallActivityAsync<EmployeeCostSetGetIn, EmployeeCostSetGetOut>(
                    It.IsAny<OrchestrationActivityCallIn<EmployeeCostSetGetIn>>(), It.IsAny<CancellationToken>()))
    ...
    {
        var queue = new Queue<Result<OrchestrationActivityCallOut<ProjectCostSetDeleteOut>, Failure<HandlerFailureCode>>>(
            deleteResultSet.AsEnumerable());
